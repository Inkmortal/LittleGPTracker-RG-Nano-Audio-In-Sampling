...
const screens = {
  ...
  power: { name: "Power Menu", status: "implemented", ref: "RG sim", summary: "Global power overlay isolated from tracker input.", columns: ["exit/debug actions"], actions: ["Power key"], capture: "assets/rg-power-menu.png", rows: ["EXIT", "CANCEL"] }
};
...
const screenManuals = {
  ...
  rg: {
    ...
    power: {
      ...
      navigation: "Accessible from anywhere through the hardware Power button. It must not leak input into the tracker underneath.",
      fields: ["Exit", "Cancel"],
